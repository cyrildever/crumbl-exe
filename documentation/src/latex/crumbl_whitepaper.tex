...
\renewcommand{\maketitlehookd}{%
    \begin{abstract}
        ...
        message to know in clear all or part of the data at any time whatsoever.
    \end{abstract}
}
...
The goal of our new algorithm, called the \texttt{crumbl} technology, is to develop simple yet particularly effective means for securing data storage.

Our procedure describes a method of secure storage of a source data, owned by one (or more) holder(s), using already proven techniques of asymmetric 
encryption with the participation of so-called trusted third parties, each having a pair of private and public keys.
